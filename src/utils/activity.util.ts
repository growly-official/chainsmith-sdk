...
export function calculateTokenActivityStats(tokenActivities: TTokenTransferActivity[], marketData: TMarketToken[]) {
 ...
 */
export function findLongestHoldingToken(chain: TChainName, transactions: TTokenTransferActivity[], address: TAddress): TLongestHoldingToken {
