...
import type { TTokenTransferActivity } from '../../types/tokens.d'

export function calculateEVMStreaksAndMetrics(transactions: TTokenTransferActivity[], address: string): TActivityStats {
